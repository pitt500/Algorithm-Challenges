...
class Solution {
    func reorderLogFiles(_ logs: [String]) -> [String] {
        ...
        for log in logs {
            isNumber(log) ? digits.append(log) : letters.append(log)
        }
        
        letters.sort(by: sortLetters)
        return letters + digits
    }
    
    private func isNumber(_ log: String) -> Bool {
        let split = log.split(separator: " ")
        return split[1] == split[1].uppercased()
    }
    
    private func sortLetters(_ log1: String, log2: String) -> Bool {
        let a = log1[log1.firstIndex(of: " ")!...] + log1[...log1.firstIndex(of: " ")!]
        let b = log2[log2.firstIndex(of: " ")!...] + log2[...log2.firstIndex(of: " ")!]
